...
public class ArrayDeque<Type> {
    ...
    private void resize(int capacity) {
        ...
        int j = 1;//I arrange the elements from the beginning of index:1 of the newArray, so after each resizing, nextFirst = 0;
    ...
    public Type removeFirst(){
        if(this.isEmpty()){
            ...
            int firstIndex = increase(nextFirst, items.length);
            Type firstElement = items[firstIndex];
    ...
    public Type removeLast(){
        if(this.isEmpty()){
            ...
            Type lastElement = items[lastIndex];
